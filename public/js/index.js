...
/***/ function(module, exports, __webpack_require__) {
	...
	var entry = __webpack_require__(426);
	boot(entry);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var XX = __webpack_require__(427);
	var classnames = __webpack_require__(394);

	var style = __webpack_require__(428);
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              ...
	              types.map(function (type, index) {
	                return React.createElement(
	                  'li',
	                  { key: index, onClick: _this2.onSelect.bind(_this2, type, index) },
	                  type.label
	                );
	              })
	            )
	          ),
	          selectedType.value == 'id' && React.createElement('input', { className: style.inputId, placeholder: '请输入16位试题编号' }),
	        ...
	        React.createElement(
	          'a',
	          { href: 'javascript:;', className: style.btnStart, onClick: this.onStartClick },
	          '开始答题'
	        ),
	        React.createElement(
	          'p',
